...
<head>
  ...
  <script type="text/javascript">
    ...
    function get_students_data()
    {
      ...
      $.ajax({
        data: "sub="+val+"&year="+year+"&dt_from="+dt_from+"&dt_to="+dt_to,
        type: "POST",
        url: "attendance_ajax2.php",
        success: function(data)
        {
          $("#pre").html(data);
        }
                ...
                <div class="row">
                  ...
                  <div class="col-sm-2">
                    <label>Date From:</label>
                      <input type="date" class="form-control" name="" id="dt_from" onchange="get_students_data()">
                  </div>
                  <div class="col-sm-2">
                    <label>Date To:</label>
                      <input type="date" class="form-control" name="" id="dt_to" onchange="get_students_data()">
                  </div>
                  <div class="col-sm-3">
                      <select class="form-control" id="sub_id" name="sub_id" onchange="get_students_data()" style="display: none;">
